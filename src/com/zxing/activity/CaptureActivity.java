...
import com.gsh.app.client.mall.activity.QrCodeInputActivity;
...
//	private Button cancelScanButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // R.string.scan_card);
        setTitleBar(false, getString(R.string.title_scan), RightAction.NONE, -1);
        CameraManager.init(getApplication());
        viewfinderView = (ViewfinderView) findViewById(R.id.viewfinder_view);
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
        hasSurface = false;
        inactivityTimer = new InactivityTimer(this);
        findViewById(R.id.flash).setOnClickListener(onClickListener);
...
//		});
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (resultString.equals("")) {
            ...
            returnCode(resultString);
        }

    }

    private void returnCode(String resultString) {
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            if (R.id.flash == v.getId()) {
                flashOn = !flashOn;
                CameraManager.get().flash(flashOn);
            } else if (R.id.input == v.getId()) {
                startActivityForResult(new Intent(CaptureActivity.this, QrCodeInputActivity.class), REQUEST_QR_CODE);
            }
        }
    };
