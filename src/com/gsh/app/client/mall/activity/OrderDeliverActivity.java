 ...
 * @author Tan Chunmao
 */
public class OrderDeliverActivity extends ActivityBase {
    ...
    @InjectView
    private TextView normal_time, order_time;
    @InjectView
    private View layout_order_time, layout_normal_time, layout_time;
    ...
    private void fillDeliverTime() {
        ...
        order_time.setText(sdf.format(deliver.orderTime));
        findViewById(R.id.change_normal_time).setOnClickListener(onClickListener);
        findViewById(R.id.change_order_time).setOnClickListener(onClickListener);
        dismissView(layout_normal_time, deliver.normalTime == 0);
        dismissView(layout_order_time, deliver.orderTime == 0);
    }
    ...
    private void fillText(List<View> views, int layoutRid, List<String> stringList, int textLayout, int textWidthRid) {
        ...
        ViewUtils.addViews(OrderDeliverActivity.this, layout, views, textWidth, Gravity.LEFT, gapWidth, 0);
    }
...
//                showTimePopupWindow();
            ...
            } else if (R.id.change_order_time == v.getId()) {
                showOrderTimeDialog();
            }
        }
    };
    ...
    private void showOrderTimeDialog() {
        ...
        orderTimeDialog.setOnTimeSelectListener(new TimeDialog.OnTimeSelectListener() {
            @Override
            public void onTimeSelect(Date date) {
                order_time.setText(sdf.format(date.getTime()));
