 ...
 * 后执行关注的方法。
 */
public class ShareSdkAdapter extends AuthorizeAdapter implements OnClickListener,
        PlatformActionListener {

    /**
     * 官方新浪微博
     */
    public static final String SDK_SINAWEIBO_UID = "5208356213";
    /**
     * 官方腾讯微博
     */
    public static final String SDK_TENCENTWEIBO_UID = "1ae172e36e57b0fa4070523d040a5c81";
...
//		llTitle.getTvTitle().setText("xxxx");
    ...
    private void initUi(String platName) {
        ...
        try {
            ctvFollow.setBackgroundResource(R.drawable.sharesdk_auth_follow_bg);
        } catch (Throwable t) {
            t.printStackTrace();
        }
        ...
        ctvFollow.setCompoundDrawablesWithIntrinsicBounds(R.drawable.sharedsdk_auth_cb, 0, 0, 0);
        ctvFollow.setGravity(Gravity.CENTER_VERTICAL);
        ctvFollow.setPadding(dp_10, dp_10, dp_10, dp_10);
        ctvFollow.setText(R.string.sharesdk_sm_item_fl_weibo);
        if (platName.equals("TencentWeibo")) {
            ctvFollow.setText(R.string.sharesdk_sm_item_fl_tc);
        }
