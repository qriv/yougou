 ...
 * <li>3. 支持子线程建立并执行{@link com.litesuits.android.async.AsyncTask}，{@link #onPostExecute(Object)}方法一定会在主线程执行</li>
 * </ul>
 * @author MaTianyu
 * 2014-1-30下午3:10:43
 */
public abstract class AsyncTask<Params, Progress, Result> {
	...
	public enum Status {
		...
		RUNNING,
		/**
		 * Indicates that {@link com.litesuits.android.async.AsyncTask#onPostExecute} has finished.
		 */
		FINISHED,
	}
	 ...
	 * <p> 加载类似瀑布流时产生的大量并发（一定程度允许任务被剔除队列）时请用{@link com.litesuits.android.async.AsyncTask#executeAllowingLoss(Object...)}
	 * @param params The parameters of the task.
	 *
	 * @return This instance of AsyncTask.
	 *
	 * @throws IllegalStateException If {@link #getStatus()} returns either
	 *         {@link com.litesuits.android.async.AsyncTask.Status#RUNNING} or {@link com.litesuits.android.async.AsyncTask.Status#FINISHED}.
	 *
	 ...
	 * <p> 加载类似瀑布流时产生的大量并发（任务数超出限制允许任务被剔除队列）时请用{@link com.litesuits.android.async.AsyncTask#executeAllowingLoss(Runnable)}
	 * @see #execute(Object[])
	 * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
	 */
	 ...
	 * <p> 任务数限制情况见{@link com.litesuits.android.async.AsyncTask.SmartSerialExecutor}
