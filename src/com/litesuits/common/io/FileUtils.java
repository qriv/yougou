...
public class FileUtils {
    ...
    public static File createTempFile() {
        File file = new File(MallApplication.context.getExternalCacheDir(), String.valueOf(System.currentTimeMillis()));
        return file;
    }

    public static final String LOCAL_AVATAR = MallApplication.context.getExternalCacheDir() + "/local_avatar.jpg";
    ...
    public static File compressPicture(File source, int maxSize) {
        try {
            ...
            return convertBitmapToFile(MallApplication.context, compressed);
